...
export function Button({ children, variant = "primary", isLoading = false, icon, disabled, className = "", ...rest }: ButtonProps) {
  const base = "flex items-center justify-center gap-2 rounded-md px-4 py-2 text-[13px] font-semibold transition-all duration-150 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed";
