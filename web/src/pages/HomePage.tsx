/**
 * HomePage — fully responsive dashboard with Navbar + Sidebar + route-based pages.
 *
 * Uses react-router-dom nested routes so each sidebar page has its own URL:
 *   - /              → Workspace (topic input + generated content)
...
/** Workspace content — the default "/" page. */
